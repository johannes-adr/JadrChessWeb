...
(function (SystemMessages) {
    ...
    SystemMessages["WARNING"] = "WARNING";
    SystemMessages["SUCCESS"] = "SUCCESS";
...
function receiveChatMessage(obj) {
    ...
    if ("systemmessage" in obj) {
        ...
        let systemMessage = obj.systemmessage;
...
function editServerInfoData(data) {
...
*/
function addInfoField(title, text, onclick) {
