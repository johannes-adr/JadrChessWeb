"use strict";
class ChessField {
    constructor(element, numelement, row, i, cover) {
        this.color = COLOR.white;
        this.figure = null;
        this.globalIndex = ChessField.i++;
        ...
        function startMove(e) {
            ...
            let vb = new VirtualBoard(thiz.getRow().getBoard());
            let f = thiz.figure;
            if (!OFFLINE_DEBUG)
                if (f.color != chessBoard.getCurrentSide() || chessBoard.getCurrentSide() != chessBoard.getThisInstanceColor()) {
                    e.preventDefault();
                    return;
                }
...
ChessField.i = 0;
ChessField.DRAG_DROP = { start: null, current: null };
ChessField.highlighted = [];
